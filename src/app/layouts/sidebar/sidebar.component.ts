...
export class SidebarComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.menuItems = MENU;
    this.updateDateTime();
    this.showAllSubMenus();  // Appel à une nouvelle méthode pour afficher tous les sous-menus
    setInterval(() => {
      this.updateDateTime();
    }, 1000);
  }
  ...
  // Nouvelle méthode pour afficher tous les sous-menus
    showAllSubMenus() {
  ...
  updateActive(event: any) {
    ...
    const clickedItem = event.target.closest('a.nav-link');
    if (clickedItem) {
  ...
  updateDateTime(): void {
    ...
    this.date = today.toLocaleDateString('fr-FR', optionsDate);
    this.time = today.toLocaleTimeString('fr-FR', optionsTime);
  }
