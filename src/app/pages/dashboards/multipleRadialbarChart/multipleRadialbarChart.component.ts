...
@Component({
  selector: 'app-multipleradialbarchat',
  templateUrl: './multipleRadialbarChart.component.html',
  styleUrls: ['./multipleRadialbarChart.component.scss']
})
export class MultipleradialbarComponent {
