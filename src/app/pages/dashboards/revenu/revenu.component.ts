 ...
 constructor(public ApiTableConfigService: ApiTableConfigService,
  ...
  ngOnInit(): void {
    ...
    this.breadCrumbItems = [
      ...
      { label: 'Suivi Revenu', active: true },
      ...
      fetchData(): void {
        ...
        const indicateur = this.selectedIndicateurs.find(i =>
          ['Revenu énergie',  
            ...
            'Chiffre d’affaires global',].includes(i)
        );
        ...
        if (indicateur && axe) {
          this.faitSuiviRevenuService.getRevenuData(indicateur, axe, startDate, endDate).subscribe({
