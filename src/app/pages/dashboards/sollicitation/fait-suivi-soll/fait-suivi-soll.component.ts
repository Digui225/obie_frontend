...
@Component({
  selector: 'app-fait-suivi-soll',
  templateUrl: './fait-suivi-soll.component.html',
  styleUrls: ['./fait-suivi-soll.component.scss']
})
export class FaitSuiviSollComponent {
  ...
  selectedItem: string | null = null; // Direction sélectionnée
   ...
   selectedSollType: 'Nombre de sollicitations clients' | 'Taux de sollicitation résolues dans les délais' | 'Taux de sollicitation résolues hors délais' | 'Droit de timbre encaissé' |'Durée moyenne de résolution des sollicitations' |
          null = null;
