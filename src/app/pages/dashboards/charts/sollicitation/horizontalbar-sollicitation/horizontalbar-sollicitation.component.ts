...
@Component({
  selector: 'app-horizontalbar-sollicitation',
  templateUrl: './horizontalbar-sollicitation.component.html',
  styleUrls: ['./horizontalbar-sollicitation.component.scss']
})
export class HorizontalbarSollicitationComponent {
  constructor() { }
