...
@Component({
  selector: 'app-basic-bar-sollicitation',
  templateUrl: './basic-bar-sollicitation.component.html',
  styleUrls: ['./basic-bar-sollicitation.component.scss']
})
export class BasicBarSollicitationComponent {
