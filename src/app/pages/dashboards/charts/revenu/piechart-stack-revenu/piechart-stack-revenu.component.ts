...
@Component({
  selector: 'app-piechart-stack-revenu',
  templateUrl: './piechart-stack-revenu.component.html',
  styleUrls: ['./piechart-stack-revenu.component.scss']
})
export class PiechartStackRevenuComponent {
