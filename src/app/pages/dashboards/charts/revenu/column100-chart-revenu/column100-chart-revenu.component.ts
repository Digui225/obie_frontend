...
@Component({
  selector: 'app-column100-chart-revenu',
  templateUrl: './column100-chart-revenu.component.html',
  styleUrls: ['./column100-chart-revenu.component.scss']
})
export class Column100ChartRevenuComponent {
