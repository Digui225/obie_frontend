...
@Component({
  selector: 'app-multiple-radialbar-energie',
  templateUrl: './multiple-radialbar-energie.component.html',
  styleUrls: ['./multiple-radialbar-energie.component.scss']
})
export class MultipleRadialbarEnergieComponent {
