...
@Component({
  selector: 'app-column100-chart-energie',
  templateUrl: './column100-chart-energie.component.html',
  styleUrls: ['./column100-chart-energie.component.scss']
})
export class Column100ChartEnergieComponent {
